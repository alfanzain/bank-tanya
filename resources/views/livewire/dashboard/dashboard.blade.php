...
<div>
    ...
    <div class="flex flex-wrap -mx-3">
        <!-- card1 -->
        <livewire:dashboard.widget :icon="'ni-money-coins'" :title="'Today\'s Money'" :value="'$53,000'" :percentageChanges="'+55%'" />

        <!-- card2 -->
        <livewire:dashboard.widget :icon="'ni-world'" :title="'Today\'s Users'" :value="'2,300'" :percentageChanges="'+3%'" />

        <!-- card3 -->
        <livewire:dashboard.widget :icon="'ni-paper-diploma'" :title="'New Clients'" :value="'+3,462'" :percentageChanges="'-2%'" />

        <!-- card4 -->
        <livewire:dashboard.widget :icon="'ni-cart'" :title="'Sales'" :value="'$103,430'" :percentageChanges="'-5%'" />
    </div>
